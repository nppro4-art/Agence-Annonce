...
export default function Login() {
  ...
  const inp = { background: 'var(--s2)', border: '1.5px solid var(--border)', borderRadius: 10, color: 'var(--white)', fontSize: 14, padding: '11px 13px', outline: 'none', width: '100%', marginBottom: 12 }
      ...
      <div style={{ background: 'var(--s1)', border: '1px solid var(--border)', borderRadius: 20, padding: '36px 28px', width: '100%', maxWidth: 380 }}>
        ...
        <form onSubmit={submit}>
          ...
          <button type="submit" disabled={loading}
            style={{ width: '100%', background: 'var(--red)', border: 'none', borderRadius: 12, color: 'white', cursor: 'pointer', fontFamily: 'Bebas Neue', fontSize: 17, letterSpacing: 1, padding: 15, opacity: loading ? .6 : 1 }}>
