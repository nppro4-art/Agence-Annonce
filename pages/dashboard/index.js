...
const CATEGORIES = {
  Voiture: [
    ...
    { key:'version', label:'Version / Finition', ph:'M Sport, GT Line, Allure...' },
    { key:'annee', label:'Annee *', ph:'2019', type:'number' },
    { key:'kilometrage', label:'Kilometrage (km) *', ph:'75000', type:'number' },
    { key:'carburant', label:'Carburant *', type:'select', opts:['Essence','Diesel','Hybride','Hybride rechargeable','Electrique','GPL','Ethanol'] },
    { key:'boite', label:'Boite de vitesse *', type:'select', opts:['Manuelle 5 vitesses','Manuelle 6 vitesses','Automatique','Semi-automatique','CVT'] },
    { key:'couleur', label:'Couleur exterieure', ph:'Noir metallise, Blanc nacre...' },
    { key:'couleurInterieur', label:'Couleur interieure', ph:'Noir, Beige, Cuir brun...' },
    ...
    { key:'consommation', label:'Consommation mixte (L/100)', ph:'5.8' },
    ...
    { key:'typeCarrosserie', label:'Type de carrosserie', type:'select', opts:['Berline','Break','SUV / 4x4','Citadine','Coupe','Cabriolet','Monospace','Utilitaire','Pick-up'] },
    ...
    { key:'ct', label:'Controle technique', type:'select', opts:['Valide - date OK','A refaire sous 2 mois','Non presente','Non applicable (< 4 ans)'] },
    { key:'dateCT', label:'Date du dernier CT', ph:'03/2024' },
    { key:'carnetEntretien', label:'Carnet entretien', type:'select', opts:['Complet et a jour','Partiel','Absent'] },
    { key:'dernierEntretien', label:'Dernier entretien effectue', ph:'Vidange + filtres a 70 000 km...' },
    { key:'pneus', label:'Etat des pneus', type:'select', opts:['Neufs','Bonne epaisseur','Usure normale','A changer bientot'] },
    { key:'freins', label:'Etat des freins', type:'select', opts:['Neufs','Bon etat','Usure normale','A surveiller'] },
    { key:'courroieDistribution', label:'Courroie de distribution', type:'select', opts:['Changee recemment','A faire','Deja faite - kilometrage inconnu','Chaine - pas de courroie'] },
    { key:'options', label:'Options et equipements', ph:'GPS, Camera recul, Toit ouvrant, Sieges chauffants, Apple CarPlay, Climatisation auto...', wide:true },
    { key:'defauts', label:'Defauts et imperfections (soyez honnete)', ph:'Petite rayure aile avant, trace sur le pare-choc, voyant de service...', wide:true },
    { key:'travauxEffectues', label:'Travaux recents effectues', ph:'Embrayage neuf a 65 000 km, batterie changee en 2023...', wide:true },
    { key:'travauxAPrevoir', label:'Travaux a prevoir', ph:'Pneus arriere bientot, vidange dans 5000 km...', wide:true },
    { key:'prix', label:'Prix demande (EUR) *', ph:'8500', type:'number' },
    { key:'negociable', label:'Prix negociable', type:'select', opts:['Oui - prix a debattre','Legerement - petit effort possible','Non - prix ferme'] },
    { key:'prixMinimum', label:'Prix minimum accepte (confidentiel)', ph:'7800', type:'number' },
    { key:'ville', label:'Ville *', ph:'Lyon, Paris, Bordeaux...' },
    { key:'disponibilite', label:'Disponibilite', type:'select', opts:['Immediate','Sous 1 semaine','En semaine uniquement','Week-end uniquement','Sur rendez-vous'] },
    { key:'livraison', label:'Livraison possible', type:'select', opts:['Non','Oui - frais a la charge acheteur','Oui - inclus dans le prix','A discuter'] },
    { key:'modePaiement', label:'Mode de paiement accepte', type:'select', opts:['Especes uniquement','Virement bancaire','Cheque de banque','Tous modes'] },
    { key:'raisonVente', label:'Raison de la vente', ph:'Achat d'un vehicule neuf, demenagement, plus besoin...' },
    { key:'urgence', label:'Urgence de vente', type:'urgence' },
  ],

  Telephone: [
    { key:'marque', label:'Marque *', ph:'Apple, Samsung, Xiaomi, OnePlus...' },
    { key:'modele', label:'Modele *', ph:'iPhone 15 Pro, Galaxy S24 Ultra...' },
    { key:'couleur', label:'Couleur *', ph:'Noir titane, Blanc, Violet...' },
    { key:'stockage', label:'Stockage *', type:'select', opts:['16 Go','32 Go','64 Go','128 Go','256 Go','512 Go','1 To'] },
    { key:'ram', label:'RAM', ph:'8 Go, 12 Go...' },
    { key:'etat', label:'Etat *', type:'select', opts:['Neuf sous blister','Comme neuf - aucune trace','Tres bon - traces minimes','Bon etat - quelques rayures','Etat correct - marques visibles'] },
    { key:'santeBatterie', label:'Sante de la batterie', ph:'94%, 87%...' },
    { key:'nombreCycles', label:'Nombre de cycles batterie', ph:'120 cycles...' },
    { key:'debloque', label:'Debloque tous operateurs', type:'select', opts:['Oui - debloque tous operateurs','Non - Orange uniquement','Non - SFR uniquement','Non - Bouygues uniquement','Non - Free uniquement'] },
    ...
    { key:'ecran', label:'Etat de l'ecran', type:'select', opts:['Parfait - aucune trace','Micro-rayures invisible en usage','Rayures legeres visibles','Fissure ou cassure'] },
    { key:'dos', label:'Etat du dos', type:'select', opts:['Parfait','Micro-rayures','Rayures visibles','Fissure'] },
    { key:'cameras', label:'Etat des cameras', type:'select', opts:['Toutes fonctionnent parfaitement','Legere buee sur une camera','Probleme sur une camera','Plusieurs cameras defectueuses'] },
    { key:'haut-parleur', label:'Haut-parleur et micro', type:'select', opts:['Fonctionnent parfaitement','Probleme leger','Defectueux'] },
    { key:'connecteurs', label:'Connecteur de charge', type:'select', opts:['Parfait','Parfois capricieux','Defectueux'] },
    { key:'accessoires', label:'Accessoires inclus', ph:'Boite d'origine, chargeur, cable, ecouteurs, coques...', wide:true },
    { key:'reparations', label:'Reparations effectuees', ph:'Ecran change en 2023, batterie remplacee...', wide:true },
    { key:'defauts', label:'Autres defauts ou remarques', ph:'Petit impact sur le bas du telephone, marque sur la vitre arriere...', wide:true },
    ...
    { key:'envoi', label:'Envoi possible', type:'select', opts:['Oui - Mondial Relay','Oui - Colissimo','Oui - tous transporteurs','Non - remise en main propre uniquement'] },
    { key:'urgence', label:'Urgence', type:'urgence' },
  ],

  Informatique: [
    { key:'type', label:'Type *', type:'select', opts:['Ordinateur portable','PC fixe','Tablette','Ecran','Imprimante','Clavier / Souris','Composant PC','Disque dur / SSD','Autre peripherique'] },
    { key:'marque', label:'Marque *', ph:'Apple, Dell, HP, Asus, Lenovo...' },
    { key:'modele', label:'Modele *', ph:'MacBook Pro 14 M3, XPS 15 9520...' },
    { key:'annee', label:'Annee d'achat', ph:'2022', type:'number' },
    { key:'processeur', label:'Processeur *', ph:'Apple M3 Pro, Intel Core i7-12700H, AMD Ryzen 9...' },
    { key:'ram', label:'RAM *', type:'select', opts:['4 Go','8 Go','16 Go','18 Go','24 Go','32 Go','48 Go','64 Go','96 Go','128 Go'] },
    { key:'stockage', label:'Stockage *', ph:'512 Go SSD NVMe, 1 To SSD...' },
    { key:'carteGraphique', label:'Carte graphique', ph:'NVIDIA RTX 4060, AMD RX 7600, Intel Iris Xe...' },
    { key:'ecranTaille', label:'Taille ecran', ph:'14 pouces, 27 pouces...' },
    { key:'ecranResolution', label:'Resolution ecran', ph:'2560x1600 Retina, 4K UHD...' },
    { key:'ecranTaux', label:'Taux de rafraichissement', ph:'60 Hz, 120 Hz, 165 Hz...' },
    { key:'autonomie', label:'Autonomie batterie reelle', ph:'8-10h en usage bureautique...' },
    { key:'santeBatterie', label:'Sante batterie / nb cycles', ph:'94%, 120 cycles...' },
    { key:'os', label:'Systeme d'exploitation', type:'select', opts:['macOS Sonoma','macOS Ventura','Windows 11','Windows 10','Linux Ubuntu','Chrome OS','Aucun'] },
    { key:'etat', label:'Etat general *', type:'select', opts:['Comme neuf','Tres bon etat','Bon etat','Etat correct','Pour pieces'] },
    { key:'ecranEtat', label:'Etat de l'ecran', type:'select', opts:['Parfait - aucune trace','Micro-rayures','Pixels morts','Fissure ou impact'] },
    { key:'clavierEtat', label:'Etat du clavier', type:'select', opts:['Parfait','Touches normales','Quelques touches capricieuses','Defectueux'] },
    { key:'touchpad', label:'Etat du touchpad', type:'select', opts:['Parfait','Fonctionnel','Defectueux'] },
    { key:'ports', label:'Ports disponibles', ph:'2x USB-C Thunderbolt, HDMI, SD, USB-A...' },
    { key:'accessoires', label:'Accessoires inclus', ph:'Chargeur d'origine, housse, souris, dock...' },
    { key:'logiciels', label:'Logiciels inclus', ph:'Office 2021, Adobe CC, Final Cut Pro...' },
    { key:'defauts', label:'Defauts et remarques', ph:'Petite marque sur le couvercle, charniere legere...', wide:true },
    ...
    { key:'ville', label:'Ville *', ph:'Paris, Lyon...' },
    { key:'envoi', label:'Envoi possible', type:'select', opts:['Oui - emballe avec soin','Non - remise en main propre'] },
    { key:'urgence', label:'Urgence', type:'urgence' },
  ],

  Mobilier: [
    { key:'type', label:'Type de meuble *', ph:'Canape, Table basse, Armoire, Lit, Bureau...' },
    { key:'marque', label:'Marque / Fabricant', ph:'Ikea, Maisons du Monde, Roche Bobois, Artisan...' },
    ...
    { key:'matiere', label:'Matiere principale *', type:'select', opts:['Bois massif','Bois stratifie MDF','Agglomere','Metal','Verre','Tissu','Cuir','Velours','Rotin / Osier','Marbre','Autre'] },
    { key:'matiereSecondaire', label:'Matiere secondaire', ph:'Pieds en metal noir, plateau en verre...' },
    ...
    { key:'places', label:'Nombre de places (si canape)', type:'select', opts:['1 place','2 places','3 places','4 places','Angle / L','Convertible'] },
    { key:'convertible', label:'Convertible en lit', type:'select', opts:['Non','Oui - clic-clac','Oui - avec coffre de rangement','Oui - meridienne'] },
    { key:'rangements', label:'Rangements integres', type:'select', opts:['Aucun','Tiroirs','Portes','Etageres','Coffre'] },
    { key:'anneeAchat', label:'Annee d'achat approximative', ph:'2021' },
    { key:'etat', label:'Etat *', type:'select', opts:['Comme neuf - jamais utilise','Tres bon etat','Bon etat - quelques traces','Etat correct - traces d'usage','Necessite un nettoyage'] },
    { key:'defauts', label:'Defauts et imperfections', ph:'Petite rayure sur le plateau, trace sur l'accoudoir...', wide:true },
    { key:'nettoyage', label:'Nettoyage / entretien effectue', type:'select', opts:['Oui - nettoye recemment','Etat d'origine'] },
    { key:'demontable', label:'Demontable / Flat pack', type:'select', opts:['Oui - facile a demonter','Partiellement demontable','Non - en un seul bloc'] },
    { key:'instructionsMontage', label:'Instructions de montage disponibles', type:'select', opts:['Oui','Non'] },
    { key:'poidEstime', label:'Poids estime (kg)', ph:'35', type:'number' },
    { key:'prix', label:'Prix demande (EUR) *', ph:'150', type:'number' },
    { key:'prixAchat', label:'Prix d'achat initial (EUR)', ph:'450', type:'number' },
    { key:'negociable', label:'Prix negociable', type:'select', opts:['Oui','Legerement','Non'] },
    { key:'ville', label:'Ville *', ph:'Lyon...' },
    { key:'aideDemenagement', label:'Aide au chargement disponible', type:'select', opts:['Oui - je peux aider','Non'] },
    { key:'urgence', label:'Urgence', type:'urgence' },
  ],

  Electromenager: [
    { key:'type', label:'Type d'appareil *', ph:'Lave-linge, Frigo, Four, Lave-vaisselle...' },
    { key:'marque', label:'Marque *', ph:'Bosch, Samsung, Whirlpool, Miele...' },
    { key:'modele', label:'Reference modele', ph:'WAN24264FR, RL34T600...' },
    { key:'annee', label:'Annee d'achat *', ph:'2020', type:'number' },
    ...
    { key:'consommationAnnuelle', label:'Consommation annuelle (kWh)', ph:'150 kWh...' },
    ...
    { key:'etat', label:'Etat *', type:'select', opts:['Excellent - comme neuf','Tres bon etat','Bon etat','Quelques traces cosmétiques','Necessite une reparation'] },
    { key:'fonctionnement', label:'Fonctionnement *', type:'select', opts:['Parfait - aucun probleme','Quelques petits defauts mineurs','Fonctionne mais reparation conseillée'] },
    ...
    { key:'dateFinGarantie', label:'Date fin de garantie', ph:'06/2025...' },
    { key:'entretienEffectue', label:'Entretien effectue', ph:'Detartrage regulier, joint remplace en 2023...', wide:true },
    { key:'defauts', label:'Defauts ou pannes historiques', ph:'Legere trace de rouille sur le tambour, joint a surveiller...', wide:true },
    { key:'accessoires', label:'Accessoires inclus', ph:'Tuyaux, grilles, bacs, livret de garantie...' },
    { key:'facture', label:'Facture d'achat disponible', type:'select', opts:['Oui','Non'] },
    { key:'prix', label:'Prix demande (EUR) *', ph:'200', type:'number' },
    { key:'prixAchat', label:'Prix d'achat initial (EUR)', ph:'600', type:'number' },
    { key:'negociable', label:'Prix negociable', type:'select', opts:['Oui','Legerement','Non'] },
    { key:'ville', label:'Ville *', ph:'Lyon...' },
    { key:'livraison', label:'Livraison possible', type:'select', opts:['Non','Oui - a vos frais','Oui - inclus'] },
    { key:'urgence', label:'Urgence', type:'urgence' },
  ],

  Vetements: [
    { key:'type', label:'Type de vetement *', ph:'Veste, Manteau, Robe, Pantalon, Sneakers...' },
    { key:'marque', label:'Marque *', ph:'Zara, H&M, Nike, Gucci, Acne Studios...' },
    { key:'collection', label:'Collection / Saison', ph:'Hiver 2023, Ete 2022...' },
    { key:'taille', label:'Taille *', ph:'M, 42, 10 ans, EU 42, US 10...' },
    ...
    { key:'nbPortes', label:'Nombre de fois porte', ph:'2-3 fois, rarement, souvent...' },
    { key:'defauts', label:'Defauts visibles', ph:'Aucun, petite pilling, decoloration legere...', wide:true },
    { key:'entretien', label:'Instructions d'entretien', ph:'Lavage 30 degres, nettoyage a sec...' },
    { key:'longueur', label:'Longueur / Coupe', ph:'Regular, Slim, Oversized, Cropped...' },
    { key:'pointure', label:'Pointure (si chaussures)', ph:'42 EU / 8.5 US...' },
    { key:'interieur', label:'Interieur double', type:'select', opts:['Oui','Non','Partiellement'] },
    { key:'accessoires', label:'Accessoires inclus', ph:'Ceinture, sac de protection, etiquette...', wide:true },
    { key:'prix', label:'Prix demande (EUR) *', ph:'25', type:'number' },
    { key:'prixAchat', label:'Prix d'achat initial (EUR)', ph:'80', type:'number' },
    { key:'negociable', label:'Prix negociable', type:'select', opts:['Oui','Legerement','Non'] },
    { key:'ville', label:'Ville *', ph:'Paris...' },
    { key:'envoi', label:'Envoi possible', type:'select', opts:['Oui - Mondial Relay','Oui - Colissimo','Oui - tous transporteurs','Non - remise en main propre'] },
    { key:'urgence', label:'Urgence', type:'urgence' },
  ],

  'Jeux video': [
    { key:'type', label:'Type *', type:'select', opts:['Jeu video','Console','Manette / Accessoire','Pack complet console + jeux','Carte cadeau / Credit'] },
    { key:'console', label:'Plateforme *', type:'select', opts:['PlayStation 5','PlayStation 4','PlayStation 3','Xbox Series X/S','Xbox One','Nintendo Switch','Nintendo Switch Lite','PC','Game Boy / DS / 3DS','Retro / Autre'] },
    { key:'titre', label:'Titre / Nom *', ph:'FIFA 24, Zelda Tears of the Kingdom, PS5 Digital...' },
    { key:'region', label:'Region', type:'select', opts:['FR / Europe (PAL)','USA (NTSC)','Japon','Multi-region'] },
    { key:'version', label:'Version', type:'select', opts:['Version physique - boite','Version numerique - code','Edition speciale / Collector','Seconde impression','Version originale 1ere impression'] },
    { key:'etat', label:'Etat *', type:'select', opts:['Neuf sous blister','Comme neuf - jamais joue','Tres bon etat','Bon etat','Etat correct - marques'] },
    { key:'boite', label:'Boite et notice', type:'select', opts:['Complet - boite + notice + jeu','Jeu seul sans boite','Boite seule sans jeu','Boite abimee mais complete'] },
    { key:'dlcInclus', label:'DLC / Contenu additionnel inclus', ph:'Season pass, DLC 1 et 2, skin exclusif...', wide:true },
    { key:'nbJeux', label:'Nombre de jeux (si lot)', ph:'5 jeux inclus...' },
  ...
  Sport: [
    ...
    { key:'modele', label:'Modele', ph:'B'Twin 540, Babolat Pure Drive...' },
    { key:'annee', label:'Annee d'achat', ph:'2021' },
    { key:'taille', label:'Taille / Pointure / Cadre', ph:'M, 42, cadre 54cm...' },
    { key:'etat', label:'Etat *', type:'select', opts:['Comme neuf - tres peu utilise','Tres bon etat','Bon etat - usure normale','Etat correct','Necessite entretien'] },
    { key:'frequenceUsage', label:'Frequence d'utilisation', type:'select', opts:['Jamais ou presque','Quelques fois par an','1 fois par mois','1 fois par semaine','Plusieurs fois par semaine'] },
    { key:'niveauPratique', label:'Niveau pour lequel il est adapte', type:'select', opts:['Debutant','Intermediaire','Avance','Competiteur','Professionnel'] },
    { key:'poids', label:'Poids (kg)', ph:'8.5', type:'number' },
    { key:'composants', label:'Composants / Specifications', ph:'Shimano 105 11v, fourche carbone, freins disque...', wide:true },
    { key:'entretienEffectue', label:'Entretien et reparations effectues', ph:'Revision complete en 2023, chaine neuve, cable de frein change...', wide:true },
    { key:'defauts', label:'Defauts et usures', ph:'Rayures sur le cadre, grips uses, pneu avant a surveiller...', wide:true },
    { key:'accessoires', label:'Accessoires inclus', ph:'Casque, pompe, cadenas, sacoche, ordinateur de bord...', wide:true },
    { key:'prix', label:'Prix demande (EUR) *', ph:'80', type:'number' },
    { key:'prixAchat', label:'Prix d'achat initial (EUR)', ph:'350', type:'number' },
    { key:'negociable', label:'Prix negociable', type:'select', opts:['Oui','Legerement','Non'] },
    { key:'ville', label:'Ville *', ph:'Lyon...' },
    { key:'livraison', label:'Livraison / Envoi possible', type:'select', opts:['Non','Oui - emballe avec soin','Oui - selon transporteur'] },
    { key:'urgence', label:'Urgence', type:'urgence' },
  ],

  Bijoux: [
    { key:'type', label:'Type *', ph:'Bague, Collier, Bracelet, Montre, Boucles d'oreilles...' },
    { key:'marque', label:'Marque / Createur', ph:'Cartier, Pandora, Daniel Wellington, Artisan local...' },
    { key:'matiere', label:'Matiere principale *', type:'select', opts:['Or 18 carats','Or 14 carats','Or 9 carats','Or rose','Or blanc','Argent 925','Argent plaque','Acier inoxydable','Platine','Titane','Plaque or','Bijou fantaisie'] },
    { key:'pierres', label:'Pierres / Ornements', ph:'Diamant 0.5ct, Saphir, Perle naturelle, Zircon...' },
    { key:'poids', label:'Poids (grammes)', ph:'5.2', type:'number' },
    { key:'taille', label:'Taille / Tour de doigt', ph:'54, 18cm de longueur, 40cm chaine...' },
    { key:'etat', label:'Etat *', type:'select', opts:['Neuf sous ecrin','Comme neuf - jamais porte','Tres bon etat','Bon etat','Quelques traces d'usure'] },
    { key:'defauts', label:'Defauts', ph:'Aucun, petite egratignure sur le fermoir...', wide:true },
    { key:'certificat', label:'Certificat d'authenticite', type:'select', opts:['Oui - inclus','Non'] },
    { key:'facture', label:'Facture d'achat', type:'select', opts:['Disponible','Non disponible'] },
    { key:'ecrin', label:'Ecrin / Boite d'origine', type:'select', opts:['Oui','Non'] },
    ...
    { key:'negociable', label:'Prix negociable', type:'select', opts:['Oui','Legerement','Non'] },
    { key:'ville', label:'Ville *', ph:'Paris...' },
    { key:'envoi', label:'Envoi possible', type:'select', opts:['Oui - lettre recommandee','Non - remise en main propre'] },
    { key:'urgence', label:'Urgence', type:'urgence' },
  ],

  Autre: [
    { key:'type', label:'Type / Description courte *', ph:'Aspirateur robot, Livre rare, Instrument de musique...' },
    { key:'marque', label:'Marque / Fabricant', ph:'(si applicable)' },
    { key:'modele', label:'Modele / Reference', ph:'(si applicable)' },
    { key:'annee', label:'Annee de fabrication / achat', ph:'(si applicable)', type:'number' },
    { key:'couleur', label:'Couleur', ph:'(si applicable)' },
    { key:'dimensions', label:'Dimensions ou caracteristiques cles', ph:'30x20x15 cm, 2.5 kg...' },
    { key:'etat', label:'Etat *', type:'select', opts:['Neuf','Comme neuf','Tres bon etat','Bon etat','Etat correct','Pour pieces'] },
    { key:'description', label:'Description detaillee *', ph:'Decrivez en detail votre article, son usage, ses caracteristiques, pourquoi vous le vendez...', wide:true },
    { key:'defauts', label:'Defauts / imperfections', ph:'Aucun, petite trace, notice manquante...', wide:true },
    ...
    { key:'prixAchat', label:'Prix d'achat initial (EUR)', ph:'(si connu)', type:'number' },
    { key:'negociable', label:'Prix negociable', type:'select', opts:['Oui','Legerement','Non'] },
    { key:'ville', label:'Ville *', ph:'Lyon...' },
    { key:'envoi', label:'Envoi possible', type:'select', opts:['Non','Oui - selon taille et poids','Oui - tous transporteurs'] },
